...
if($mvcore['buylevel_level_value'] == '16' && $optionID == '16') { $b_level = '16000'; $points_cost = $mvcore['buylevel_cost']; } 
elseif($mvcore['buylevel_level_value'] == '32' && $optionID == '32') { $b_level = '32000'; $points_cost = $mvcore['buylevel_cost'] * 2; }
elseif($mvcore['buylevel_level_value'] == 'both') {
...
else{ $level_is = '0'; echo'<div class="mvcore-nNote mvcore-nFailure">Selected level was not found, choose 16k or 32k</div>'; };
