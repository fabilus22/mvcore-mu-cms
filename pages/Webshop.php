...
if($_GET['op1'] == 'webshop' && $_GET['op3'] != 'sc' || $_GET['op1'] == 'Webshop' && $_GET['op3'] != 'sc') { $_SESSION['webshop_allow_reload'] = '0'; };
...
//checking all
	...
	if($mvcore['max_exc_opt'] <= $_POST['exc']) { $item_exc = $mvcore['max_exc_opt']; } else { $item_exc = $_POST['exc']; };
	if($mvcore['max_sock_opt'] <= $_POST['sk']) { $item_sk = $mvcore['max_sock_opt']; } else { $item_sk = $_POST['sk']; };
	
	
	if($mvcore['w_exc_refin_item'] == 'no' && $item_refin >= '1') { $item_exc = 0; }; // Item 380
	
	$sanci= mssql_query("Select anc_name from MVCore_Wshopp_Ancient where item_id='".$item_id."' and item_cat='".$item_cat."'"); $sanci= mssql_fetch_row($sanci);
	
	if($mvcore['w_exc_anc_item'] == 'no' && $sanci[0] != '') { $item_exc = 0; }; // Ancient.
	
	if($mvcore['w_harm_anc_item'] == 'no' && $sanci[0] != '') { $item_harms = 0; }; // Ancient.

$check_item = mssql_query("Select item_name, item_cost, zen_cost, can_buy_w_money2, can_buy_w_money1, can_buy_w_zen, is_harmony, bought_count, category, id, is_socket, is_ancient  from MVCore_Wshopp  where item_name='".$item_name."' and category='".$item_cat."'");
...
if($mvcore['socket_exc_item'] == 'no' && $check_item_ok[10] >= '1') { $item_exc = 0; }; // Excellent disable if Socket item.

if($mvcore['sockets_parts'] == 'no') { $drop_sockets = 'where type >= 1 and sok_on_off = 1'; }
elseif($item_cat >= '0' && $item_cat <= '5' ) { $drop_sockets = 'where type = 1 and sok_on_off = 1'; }
elseif($item_cat >= '6' && $item_cat <= '11' ) { $drop_sockets = 'where type = 2 and sok_on_off = 1'; };
...
//allow buy with ?
if($check_item_ok[3] == '1') { $drop_costshow_gcred = '<tr><td>'.$mvcore['money_name2'].':</td><td><b><span id="total_credits_g">'.floor($calc_gold_cost).'</span></b></td></tr>'; };
if($mvcore['cost_cred_to_creda'] == 'yes') { $drop_costshow_cred = '<tr><td>'.$mvcore['money_name1'].':</td><td><b><span id="total_credits">'.$check_item_ok[1].'</span></b></td></tr>'; };
if($mvcore['cost_cred_to_zena'] == 'yes') { $drop_costshow_zen = '<tr><td>Zen:</td><td><b><span id="total_zen">'.$zen_cost.'</span></b></td></tr>'; };

if($check_item_ok[3] == '1') { $drop_cost_gcred = '<button id="gcred" class="mvcore-button-style" name="buygoldcred">'.main_p_webshop_buywith.' '.$mvcore['money_name2'].'</button>'; };
if($mvcore['cost_cred_to_creda'] == 'yes') { $drop_cost_cred = '<button id="tokens" class="mvcore-button-style" name="buycred">'.main_p_webshop_buywith.' '.$mvcore['money_name1'].'</button>'; };
if($mvcore['cost_cred_to_zena'] == 'yes') { $drop_cost_zen = '<button id="tokens" class="mvcore-button-style" name="buyzen">'.main_p_webshop_buywith.' Zen</button>'; };
//end allow buy
...
$drop_ad_opt = '
				<select style="width:95% !important;" class="mvcore-select-main" id="item_opt" onchange="checkall();" name="item_opt">
					...
					'; if($mvcore['max_ad_opt_jof'] >= '1') { $drop_ad_opt .= '<option value="1">Additional Damage + 4</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '2') { $drop_ad_opt .= '<option value="2">Additional Damage + 8</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '3') { $drop_ad_opt .= '<option value="3">Additional Damage + 12</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '4') { $drop_ad_opt .= '<option value="4">Additional Damage + 16</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '5') { $drop_ad_opt .= '<option value="5">Additional Damage + 20</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '6') { $drop_ad_opt .= '<option value="6">Additional Damage + 24</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '7') { $drop_ad_opt .= '<option value="7">Additional Damage + 28</option>'; };
					$drop_ad_opt .= '
			</select>
...
$drop_ad_opt = '
				<select style="width:95% !important;" class="mvcore-select-main" id="item_opt" onchange="checkall();" name="item_opt">
					...
					'; if($mvcore['max_ad_opt_jof'] >= '1') { $drop_ad_opt .= '<option value="1">Additional Defense + 4</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '2') { $drop_ad_opt .= '<option value="2">Additional Defense + 8</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '3') { $drop_ad_opt .= '<option value="3">Additional Defense + 12</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '4') { $drop_ad_opt .= '<option value="4">Additional Defense + 16</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '5') { $drop_ad_opt .= '<option value="5">Additional Defense + 20</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '6') { $drop_ad_opt .= '<option value="6">Additional Defense + 24</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '7') { $drop_ad_opt .= '<option value="7">Additional Defense + 28</option>'; };
					$drop_ad_opt .= '
			</select>
...
$drop_ad_opt = '
				<select style="width:95% !important;" class="mvcore-select-main" id="item_opt" onchange="checkall();" name="item_opt">
					...
					'; if($mvcore['max_ad_opt_jof'] >= '1') { $drop_ad_opt .= '<option value="1">Additional Wizardry DMG + 4</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '2') { $drop_ad_opt .= '<option value="2">Additional Wizardry DMG + 8</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '3') { $drop_ad_opt .= '<option value="3">Additional Wizardry DMG + 12</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '4') { $drop_ad_opt .= '<option value="4">Additional Wizardry DMG + 16</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '5') { $drop_ad_opt .= '<option value="5">Additional Wizardry DMG + 20</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '6') { $drop_ad_opt .= '<option value="6">Additional Wizardry DMG + 24</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '7') { $drop_ad_opt .= '<option value="7">Additional Wizardry DMG + 28</option>'; };
					$drop_ad_opt .= '
			</select>
...
$drop_ad_opt = '
				<select style="width:95% !important;" class="mvcore-select-main" id="item_opt" onchange="checkall();" name="item_opt">
					...
					'; if($mvcore['max_ad_opt_jof'] >= '1') { $drop_ad_opt .= '<option value="1">Automatic HP Recovery + 1%</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '2') { $drop_ad_opt .= '<option value="2">Automatic HP Recovery + 2%</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '3') { $drop_ad_opt .= '<option value="3">Automatic HP Recovery + 3%</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '4') { $drop_ad_opt .= '<option value="4">Automatic HP Recovery + 4%</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '5') { $drop_ad_opt .= '<option value="5">Automatic HP Recovery + 5%</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '6') { $drop_ad_opt .= '<option value="6">Automatic HP Recovery + 6%</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '7') { $drop_ad_opt .= '<option value="7">Automatic HP Recovery + 7%</option>'; };
					$drop_ad_opt .= '
			</select>
...
$drop_ad_opt = '
				<select style="width:95% !important;" class="mvcore-select-main" id="item_opt" onchange="checkall();" name="item_opt">
					...
					'; if($mvcore['max_ad_opt_jof'] >= '1') { $drop_ad_opt .= '<option value="1">Max Mana Increase + 1%</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '2') { $drop_ad_opt .= '<option value="2">Max Mana Increase + 2%</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '3') { $drop_ad_opt .= '<option value="3">Max Mana Increase + 3%</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '4') { $drop_ad_opt .= '<option value="4">Max Mana Increase + 4%</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '5') { $drop_ad_opt .= '<option value="5">Max Mana Increase + 5%</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '6') { $drop_ad_opt .= '<option value="6">Max Mana Increase + 6%</option>'; };
					if($mvcore['max_ad_opt_jof'] >= '7') { $drop_ad_opt .= '<option value="7">Max Mana Increase + 7%</option>'; };
					$drop_ad_opt .= '
			</select>
...
<?php if($mvcore['shop_disc'] == 'on'){ if($mvcore['shop_disc_start'] != 1) { echo'<div style="text-align:left;"><div><b>'.main_p_webshop_discstart.' '.$OutPutDateOfDisct.' '.main_p_webshop_at.' '.date("h:i A",$mvcore['shop_start_at']).'</b></div></div>'; } }; ?>
<?php if($mvcore['shop_disc'] == 'on'){ if($mvcore['shop_disc_start'] == 1) { echo'<center><div><b>'.main_p_webshop_webshdisc.' '.$mvcore['shop_perc'].'% '.main_p_webshop_foronehour.'</b></div></center>'; } }; ?>
<?php if($mvcore['web_shop_disc_vip'] > '0' && $mvcore['vip_sys_active'] == '1'){ echo'<center><div><b>'.main_p_webshop_webshopdiscount.' '.$mvcore['web_shop_disc_vip'].'% '.main_p_webshop_forviponly.'</b></div></center>'; }; ?>
<center>
<div id="supitemchc">
...
<div style="width:100%;">
	<div style="margin:10px 0px;" class="unselectable">
													...
													<select style="width:95% !important;" id="item_level" class="mvcore-select-main" onchange="checkall();" name="item_level">
														<option value="0" selected="selected">Level + 0</option>
																<?php
																	for($i=0;$i < 16;++$i) {
																		$value = $i + 1;
																		if($value > $mvcore['pentagram_it_max_lev']) {} else {
													...
													<select style="width:95% !important;" id="item_level" class="mvcore-select-main" onchange="checkall();" name="item_level">
														<option value="0" selected="selected">Level + 0</option>
																<?php
																	for($i=0;$i < 16;++$i) {
																		$value = $i + 1;
																		if($value > $mvcore['it_max_lev']) {} else {
																			echo'<option value="'.$value.'">Level + '.$value.'</option>';
																		}
																	};
																?>
										...
										<?php if($mvcore['db_season'] >= '8') { ?>
											...
											<?php if($check_item_ok[8] == 12 && $check_item_ok[9] == 60) { ?><select style="width:95% !important;" id="item_level" class="mvcore-select-main" onchange="checkall();" name="item_level">
											...
											<?php if($check_item_ok[8] == 12 && $check_item_ok[9] == 61) { ?><select style="width:95% !important;" id="item_level" class="mvcore-select-main" onchange="checkall();" name="item_level">
											...
											<?php if($check_item_ok[8] == 12 && $check_item_ok[9] == 62) { ?><select style="width:95% !important;" id="item_level" class="mvcore-select-main" onchange="checkall();" name="item_level">
											...
											<?php if($check_item_ok[8] == 12 && $check_item_ok[9] == 63) { ?><select style="width:95% !important;" id="item_level" class="mvcore-select-main" onchange="checkall();" name="item_level">
											...
											<?php if($check_item_ok[8] == 12 && $check_item_ok[9] == 64) { ?><select style="width:95% !important;" id="item_level" class="mvcore-select-main" onchange="checkall();" name="item_level">
											...
											<?php if($check_item_ok[8] == 12 && $check_item_ok[9] == 65) { ?><select style="width:95% !important;" id="item_level" class="mvcore-select-main" onchange="checkall();" name="item_level">
											...
											<div style="margin:10px 0px;">		
												<!-- Slot3 -->
													<select style="width:95% !important;" class="mvcore-select-main" name="socket3" id="socket3">
																<option value="254" selected="selected">EMPTY (No Mounting Slot)</option>
														<?php
															$slc_ertel= mssql_query("Select top 5 ertel_name, ertel_id from MVCore_Wshopp_Ertel where ertel_cat = '3' and ertel_type = '".$check_item_ok[9]."' order by ertel_id asc");
															for($i=0;$i < mssql_num_rows($slc_ertel);++$i) {
																$slc_ertels= mssql_fetch_row($slc_ertel);
																echo'<option value="'.$slc_ertels[1].'">'.$slc_ertels[0].'</option>';
															};
											...
											<div style="margin:10px 0px;">		
												<!-- Slot4 -->
													<select style="width:95% !important;" class="mvcore-select-main" name="socket4" id="socket4">
																<option value="254" selected="selected">EMPTY (No Mounting Slot)</option>
														<?php
															$slc_ertel= mssql_query("Select top 5 ertel_name, ertel_id from MVCore_Wshopp_Ertel where ertel_cat = '4' and ertel_type = '".$check_item_ok[9]."' order by ertel_id asc");
															for($i=0;$i < mssql_num_rows($slc_ertel);++$i) {
																$slc_ertels= mssql_fetch_row($slc_ertel);
																echo'<option value="'.$slc_ertels[1].'">'.$slc_ertels[0].'</option>';
															};
											...
											<div style="margin:10px 0px;">		
												<!-- Slot5 -->
													<select style="width:95% !important;" class="mvcore-select-main" name="socket5" id="socket5">
																<option value="254" selected="selected">EMPTY (No Mounting Slot)</option>
														<?php
															$slc_ertel= mssql_query("Select top 5 ertel_name, ertel_id from MVCore_Wshopp_Ertel where ertel_cat = '5' and ertel_type = '".$check_item_ok[9]."' order by ertel_id asc");
															for($i=0;$i < mssql_num_rows($slc_ertel);++$i) {
																$slc_ertels= mssql_fetch_row($slc_ertel);
																echo'<option value="'.$slc_ertels[1].'">'.$slc_ertels[0].'</option>';
															};
												...
												<?php if($item_harms != '0' && $check_item_ok[6] >= '1' && $mvcore['har_opt_buy'] == 'yes') { ?>
													...
													<select style="width:95% !important;" class="mvcore-select-main" id="item_harm" onchange="checkall();" name="item_harm">
														...
														if($check_item_ok[8] >= 0 && $check_item_ok[8] <= 4) { // Swords
															$select_joh_info= mssql_query("Select top 99 joh_name from MVCore_Wshopp_Harmony where joh_type='1' and joh_onoff = '1'");
															...
															$select_joh_info= mssql_query("Select top 99 joh_name from MVCore_Wshopp_Harmony where joh_type='2' and joh_onoff = '1'");
															for($i=0;$i < mssql_num_rows($select_joh_info);++$i) {
																	$value = $i + 1;
																$s_joh_i= mssql_fetch_row($select_joh_info);
																echo'<option value="'.$s_joh_i[0].'">'.$s_joh_i[0].'</option>';
	...
	<div style="margin:10px 0px;">
											<?php $sanci= mssql_query("Select anc_name from MVCore_Wshopp_Ancient where item_id='".$item_id."' and item_cat='".$item_cat."'");$sanci= mssql_fetch_row($sanci); if($sanci[0] != '' && $mvcore['anc_opt_buy'] == 'yes') { ?>

													<select style="width:95% !important;" class="mvcore-select-main" id="item_anc" onchange="checkall();" name="item_anc">
														<option value="na" selected="selected"> - Select Ancient Set - </option>
																<?php
																	$select_anc_info= mssql_query("Select anc_name,anc_name2,item_id,item_cat from MVCore_Wshopp_Ancient where item_id='".$item_id."' and item_cat='".$item_cat."'");
																	...
																	if($s_anc_opt2[1] != '' && $s_anc_opt2[1] != ' ') { echo'<option value="10" style="padding-left:5px;">Set '.$s_anc_opt2[0].'</option>'; };
																?>
													</select>
										...
										<?php if($check_item_ok[10] >= '1' && $mvcore['soc_opt_buy'] == 'yes') { ?>
											<?php if($item_sk >= '1') { ?>
													<select style="width:95% !important;" class="mvcore-select-main" name="socket1" onchange="checkall();" id="socket1">
														...
														<?php
															$select_sk_info= mssql_query("Select top 250 sok_name, sok_id from MVCore_Wshopp_Socket ".$drop_sockets."");
											...
											<?php } ?>
											<?php if($item_sk >= '2') { ?>
													<select style="width:95% !important;" class="mvcore-select-main" name="socket2" onchange="checkall();" id="socket2">
																<option value="254">EMPTY (No Mounting Socket)</option>
														<?php
															$select_sk_info= mssql_query("Select top 250 sok_name, sok_id from MVCore_Wshopp_Socket ".$drop_sockets."");
															for($i=0;$i < mssql_num_rows($select_sk_info);++$i) {
											...
											<?php } ?>
											<?php if($item_sk >= '3') { ?>
													<select style="width:95% !important;" class="mvcore-select-main" name="socket3" onchange="checkall();" id="socket3">
																<option value="254">EMPTY (No Mounting Socket)</option>
														<?php
															$select_sk_info= mssql_query("Select top 250 sok_name, sok_id from MVCore_Wshopp_Socket ".$drop_sockets."");
															for($i=0;$i < mssql_num_rows($select_sk_info);++$i) {
											...
											<?php } ?>
											<?php if($item_sk >= '4') { ?>
													<select style="width:95% !important;" class="mvcore-select-main" name="socket4" onchange="checkall();" id="socket4">
																<option value="254">EMPTY (No Mounting Socket)</option>
														<?php
															$select_sk_info= mssql_query("Select top 250 sok_name, sok_id from MVCore_Wshopp_Socket ".$drop_sockets."");
															for($i=0;$i < mssql_num_rows($select_sk_info);++$i) {
											...
											<?php } ?>
											<?php if($item_sk >= '5') { ?>
													<select style="width:95% !important;" class="mvcore-select-main" name="socket5" onchange="checkall();" id="socket5">
																<option value="254">EMPTY (No Mounting Socket)</option>
														<?php
															$select_sk_info= mssql_query("Select top 250 sok_name, sok_id from MVCore_Wshopp_Socket ".$drop_sockets."");
															for($i=0;$i < mssql_num_rows($select_sk_info);++$i) {
...
$check_item_data = mssql_query("Select item_name, item_cost, zen_cost, can_buy_w_money2, can_buy_w_money1, can_buy_w_zen, is_harmony, bought_count, has_luck, id, category, x, y, durability, is_socket, can_buy, has_skill, has_luck, is_ancient from MVCore_Wshopp  where item_name='".$_POST['buy_item']."'");
...
if($mvcore['soc_opt_buy'] == 'yes') {
	if($check_item_dat[14] >= '1') {
		...
		if($mvcore['socket_type'] == 'scfmt'){
			...
			$item_sockets1 = $item_socket1;
			$item_sockets2 = $item_socket2;
			$item_sockets3 = $item_socket3;
			$item_sockets4 = $item_socket4;
			$item_sockets5 = $item_socket5;
		}
	
	//checking for disabled sockets.
	$select_soc_infod1= mssql_query("Select sok_on_off from MVCore_Wshopp_Socket where sok_id='".$item_sockets1."'"); $check_soc_infod1 = mssql_fetch_row($select_soc_infod1);
	$select_soc_infod2= mssql_query("Select sok_on_off from MVCore_Wshopp_Socket where sok_id='".$item_sockets2."'"); $check_soc_infod2 = mssql_fetch_row($select_soc_infod2);
	$select_soc_infod3= mssql_query("Select sok_on_off from MVCore_Wshopp_Socket where sok_id='".$item_sockets3."'"); $check_soc_infod3 = mssql_fetch_row($select_soc_infod3);
	$select_soc_infod4= mssql_query("Select sok_on_off from MVCore_Wshopp_Socket where sok_id='".$item_sockets4."'"); $check_soc_infod4 = mssql_fetch_row($select_soc_infod4);
	$select_soc_infod5= mssql_query("Select sok_on_off from MVCore_Wshopp_Socket where sok_id='".$item_sockets5."'"); $check_soc_infod5 = mssql_fetch_row($select_soc_infod5);
...
$get_ware_info_name= mssql_query("Select money from warehouse where AccountID='".$useracc."'");
$drop_infoa= mssql_fetch_row($get_ware_info_name);

$get_credits = mssql_query("select ".$mvcore['credits_column'].",".$mvcore['credits2_column']." from ".$mvcore['credits_table']." where ".$mvcore['user_column']." ='".$useracc."'"); 
$get_creditss = mssql_fetch_row($get_credits); if($pvsWebshop != 'ok4722') { exit; };

	$sys_starst = mssql_query("select name from character where AccountID = '".$useracc."'"); // Check if Char Exists.
	$drop_info = mssql_fetch_row($sys_starst);
...
if($has_error >= '1'){} else {
		...
		$up_data = mssql_query("UPDATE warehouse SET Items = ".$mynewitems." WHERE AccountId='".$useracc."'");
			...
			$up_data = mssql_query("UPDATE MVCore_Wshopp SET bought_count = bought_count + '1' WHERE item_name='".$_POST['buy_item']."'");
	
		//Take Cost
		if($is_cost_type == '3') {
			$run = mssql_query("update warehouse set money = money - '".$item_cost_zen."' where accountid ='".$useracc."'"); 
			$do_insert = mssql_query("insert into MVCore_Wshopp_Item_Log (name,hex,cost,boughtby,date,type) VALUES ('".$check_item_dat[0]."','".$hex."','".$item_cost_zen."','".$useracc."','".time()."','3')");
		}
		elseif($is_cost_type == '2') {
			$run = mssql_query("update ".$mvcore['credits_table']." set ".$mvcore['credits_column']." = ".$mvcore['credits_column']." - '".$item_cost_cred."' where ".$mvcore['user_column']." ='".$useracc."'"); 
			$do_insert = mssql_query("insert into MVCore_Wshopp_Item_Log (name,hex,cost,boughtby,date,type) VALUES ('".$check_item_dat[0]."','".$hex."','".$item_cost_cred."','".$useracc."','".time()."','2')");
		}
		elseif($is_cost_type == '1') {
			$run = mssql_query("update ".$mvcore['credits_table']." set ".$mvcore['credits2_column']." = ".$mvcore['credits2_column']." - '".floor($calc_into_gold)."' where ".$mvcore['user_column']." ='".$useracc."'"); 
			$do_insert = mssql_query("insert into MVCore_Wshopp_Item_Log (name,hex,cost,boughtby,date,type) VALUES ('".$check_item_dat[0]."','".$hex."','".floor($calc_into_gold)."','".$useracc."','".time()."','1')");
		};
		//end
...
if($_POST['getClassCode'] == '' && $_POST['getClassCode'] == '-1') {
	$select_items = mssql_query("select top 300 item_name, category, id, item_cost, can_buy, max_excellent, has_refinery, is_socket, is_ancient, has_skill, has_luck, max_level, clases from MVCore_Wshopp where category = '".$cat_drop."' and can_buy >= '1' order by item_cost asc");
} else { 
	$showtopcl1 = "".$nvalue1.","; $showtopcl2 = "".$nvalue2.","; $showtopcl3 = "".$nvalue3.","; $showtopcl4 = "".$nvalue4.",";
	$select_items = mssql_query("select top 300 item_name, category, id, item_cost, can_buy, max_excellent, has_refinery, is_socket, is_ancient, has_skill, has_luck, max_level, clases from MVCore_Wshopp where category = '".$cat_drop."' and can_buy >= '1' and CHARINDEX('".$showtopcl1."', clases) > 0 or category = '".$cat_drop."' and can_buy >= '1' and CHARINDEX('".$showtopcl2."', clases) > 0 or category = '".$cat_drop."' and can_buy >= '1' and CHARINDEX('".$showtopcl3."', clases) > 0 or category = '".$cat_drop."' and can_buy >= '1' and CHARINDEX('".$showtopcl4."', clases) > 0 order by item_cost asc");
}

for($i=0;$i < mssql_num_rows($select_items);++$i) {
$select_items_drop = mssql_fetch_row($select_items);

if(strlen($select_items_drop[0]) > '17'){ $ech_name = '<font color="'.$mvcore['webshop_s_textcolor'].'">'.substr($select_items_drop[0], 0, 14).'...</font>'; } else { $ech_name = '<font color="'.$mvcore['webshop_s_textcolor'].'">'.$select_items_drop[0].'</font>'; };
	
if (file_exists("system/engine_images/webshop/item_images/".$select_items_drop[1]."/".$select_items_drop[2].".gif")) { $image_load = "system/engine_images/webshop/item_images/".$select_items_drop[1]."/".$select_items_drop[2].".gif"; } else { $image_load = 'system/engine_images/webshop/item_images/no-img.gif'; };
...
$formCreate = '
<form action="-id-'.$_GET['op1'].'-id-'.$_GET['op2'].'.html" method="POST" id="formSubmit'.$select_items_drop[2].''.$select_items_drop[1].'">
<input type="hidden" name="name" value="'.$select_items_drop[0].'">
<input type="hidden" name="ids" value="'.$select_items_drop[2].'">
<input type="hidden" name="cat" value="'.$select_items_drop[1].'">
<input type="hidden" name="exc" value="'.$select_items_drop[5].'">
<input type="hidden" name="refin" value="'.$select_items_drop[6].'">
<input type="hidden" name="sk" value="'.$select_items_drop[7].'">
<input type="hidden" name="anc" value="'.$select_items_drop[8].'">
<input type="hidden" name="skill" value="'.$select_items_drop[9].'">
<input type="hidden" name="luck" value="'.$select_items_drop[10].'">
<input type="hidden" name="level" value="'.$select_items_drop[11].'">
...
<td class="mvcore-itemnclass">
	...
	<table align="center" cellpadding="0" cellspacing="0">
		<tr onclick="document.getElementById(\'formSubmit'.$select_items_drop[2].''.$select_items_drop[1].'\').submit();">
