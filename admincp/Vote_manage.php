		...
		<div class="widget fluid" id="topvotersett">
			<div class="whead"><h6>Top Voter Settings</h6></div>
					...
					<div class="formRow">
						<div class="grid3"><label>Voting Reward Type:</label></div>
						<div class="grid9">
							<select style="width:100%;" id="vote_top_rw_type" name="vote_top_rw_type" style="display: none;" data-placeholder="Choose a option..." class="select" tabindex="2">
								<option value=""></option> 
								<option value="1" <?php if($mvcore['vote_top_rw_type'] == '1') { echo 'selected'; } else { echo ''; }; ?>><?php echo $mvcore['money_name1'];?></option> 
								<option value="2" <?php if($mvcore['vote_top_rw_type'] == '2') { echo 'selected'; } else { echo ''; }; ?>><?php echo $mvcore['money_name2'];?></option>
								<option value="3" <?php if($mvcore['vote_top_rw_type'] == '3') { echo 'selected'; } else { echo ''; }; ?>><?php echo $mvcore['money_name1'];?> & <?php echo $mvcore['money_name2'];?></option>
							</select>
						</div>             
					</div>
		</div>
...
$(document).ready(function() {
	...
	$( "#topvotersett" ).on('change', function() {
		var getAllValues = $("#vote_top_of option:selected").val()+"-ids-"
			...
			+$("#vote_top_at option:selected").val()+"-ids-"
			+$("#vote_top_rw_type option:selected").val();
			$.post("acps.php", {
